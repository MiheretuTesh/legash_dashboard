...
interface FormSelectFieldHospitalAddProps {
  fieldName: string;
  fieldLabel?: string;
  options: any[];
  formikChangeHandler?: {
...
const FormSelectFieldHospitalAdd = ({
  fieldName,
  fieldLabel,
  options,
  initialValue,
  ...
  isFormName,
  setHospitalAdminId,
}: FormSelectFieldHospitalAddProps) => {
...
export default FormSelectFieldHospitalAdd;
